 ...
 *
 * ⚠️ DEPRECATED - This service is no longer used with the simplified schema.
 *
 * The new tag-based sync approach doesn't require conflict detection:
 * - Mentors table is the single source of truth for mentor data
 * - raw_gb_full_contacts contains full Givebutter contacts (tag: "Mentors 2025")
 * - No bidirectional field syncing
 *
